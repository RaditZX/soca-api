<template>
    <div class="container" id="content-container">
         <h1>Proctoring</h1>
            <div class="line"></div>
                <div class="desc">
                    <p> Test proctoring is <strong>testing overseen by an authorized, neutral, proctor,</strong> who ensures the identity of the test taker and the integrity of the test taking environment. In short, a proctor is a proxy for the instructor, who oversees a. test.</p>
                </div>
                <div class="image">
                    <img src="../../assets/Konten SOCA AI _ Exam ProctoringI.png" alt="">
                    <span>Illustration SOCA Face Recognition & Face Detection</span>
                </div><div class="line"></div>
                 <div class="desc">
                    <p style="font-weight:bold;">
                What happens in proctoring ?
                    </p>
                </div>
                <div class="desc">
                    <p >
                 Proctored exams are <strong> timed exams that you take while proctoring software monitors your computer's desktop, webcam video and audio.</strong> The data recorded by the proctoring software is transferred to a proctoring service for review. Proctored exams may or may not be required for your course and enrollment track.
                    </p>
                </div>
                <div class="desc">
                    <p style="font-weight:bold;">
                     What is proctoring in education ?
                    </p>
                </div>
                <div class="desc">
                    <p >
                 Online proctoring services are a key component of fully online learning. These services provide the means for <strong>verifying the identity of students at a distance before an assessment </strong>  and the methods for ensuring that students taking the assessment are not cheating or getting unauthorized support.
                    </p>
                </div>
            <div class="line"></div>
                <h2>API Documentation For Using Proctoring</h2>
                    <div class="desc">
                        <p> Before using api proctoring, you must first register user data (master data). Below are api-docs documentation for user data which can later be monitored by proctoring ai referring to the unique code entered.</p>
                    </div>
             <div class="row mt-3">
                    ...
                    <div class="advantagebox" style=" border-left: 5px solid blue;">
                            <div class="row">
                                <div class="flex-containers">
                                    <div class="checkicon">
                                        <svg style="color: blue;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
            ...
            <div class="desc">
                <p>Here are the steps to use the facial recognition api according to the flow :</p>
            </div>
            <div class="row">
                <div class="col-md-12 mt-2">
                    <h3>1. Users (Master Data)</h3>
                    <p>To manage the master data of users taking exams using a proctoring service.</p>
                    <div class="api-details">
                        ...
                        <div class="details" ref="details">
                            ...
                            <div class="query">
                                <p >page</p>
                                <p style="padding-left: 193px;">string</p>
                                <p style="padding-left: 50px;">set page for pagination data</p>
                             </div>
                               <div class="query">
                                <p >limit</p>
                                <p style="padding-left: 198px;">string</p>
                                <p style="padding-left: 50px;">set limit data for pagination data</p>
                             </div>
                      ...
                      <div class="api-details" style="margin-top: 20px;">
                        <div class="head">
                            ...
                            <div class="button-details" ref="buttondetails1" @click="showdetails1()">
                                <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-circle-fill" viewBox="0 0 16 16">
                                <path d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
                                </svg>
                            </div>
             ...
             <div class="row mt-5">
                <div class="col-md-12 mt-2">
                    <h3>2. Proctoring Service</h3>
                    <p>After the user data has been registered, the user can start using the proctoring service by entering the unique code and image data to be processed in Base64 format.</p>
                    <h5 style="margin-bottom: 30px ;">(max file size : 800kb)</h5>
                    <div class="api-details">
                        <div class="head">
                            <div class="api-head">
                                <div class="api-icon-post">
                                ...
                                <div class="link">
                                    <p style="color:rgba(136,153,168,1.00) ;">https://127.0.0.1:5000/api</p>
                                    <p style="font-weight: bold;">/v1/proctoring</p>
                                </div>
                            </div>
                        ...
                        <p style="font-weight: bold; margin-left:8px;">Proctoring Service</p>
            ...
            <h3 class="mt-5">Response Body</h3>
            <div class="row mt-5">
                <div class="col-md-12 mt-2">
                    <div class="code-all">
                        <div class="code"  >
...
{
  "status": true,
  "message": "Proctoring Service Successfully",
  "data": {
    "objects": [
      {
        "class": "Orang",
        "score": 0.5511986017227173,
        "rect": {
          "x1": 136,
          "y1": 163,
          "x2": 257,
   ...
   "movements":{
      ...
      "mouth": {
        "value": "Terbuka"
            ...
            <div class="line"></div>
            <h1 class="mt-5">Example Implementation</h1>
            <div class="image-flex">
                    <img class="mt-5" src="../../assets/Screen Shot 2022-01-05 at 17.50.13.png" alt="">
                    <img class="mt-5" style="height: 86.5%;" src="../../assets/Screen Shot 2022-01-05 at 17.52.13.png" alt="">
                    <img class="mt-5" style="height: 86.5%;" src="../../assets/Screen Shot 2022-01-05 at 17.57.26.png" alt="">
                </div>
            <div class="image">
                <img class="mt-5" src="../../assets/Screen Shot 2022-01-06 at 18.54.45.png" alt="">
                <span>Example Implementation In KP3SKP Proctoring System</span>
            </div>
            </div>
                 <div class="flex-container">
                    <div class="button-route">
                        <router-link to="/Proctoring-AI/face-recognation">
                            <div class="previous">
                                <div class="icon">
                    ...
                    <div class="button-route">
                        <router-link to="/Proctoring-AI/object-recognation">
                            <div class="previous" style="text-align: left;">
                                <div class="text">
                                    <span>Next</span>
                                    <p>Object Recognation</p>
                                </div>
                                <div class="icon">
        ...
        methods: {
            ...
            showdetails() {
                if (this.show == false) {
                    ...
                    this.$refs.buttondetails.style.transform = "rotate(90deg)"
                    this.$refs.buttondetails.style.transition = "all 0.5s"
                } else {
                    this.show = false
                    this.$refs.details.style.display = "none"
                    this.$refs.buttondetails.style.transform = "rotate(0deg)"
                    this.$refs.buttondetails.style.transition = "all 0.5s"
                }
            },
             showdetails1() {
                if (this.show == false) {
                    this.show = true
                    this.$refs.details1.style.display = "block"
                    this.$refs.buttondetails1.style.transform = "rotate(90deg)"
                    this.$refs.buttondetails1.style.transition = "all 0.5s"
                } else {
                    this.show = false
                    this.$refs.details1.style.display = "none"
                    this.$refs.buttondetails1.style.transform = "rotate(0deg)"
                    this.$refs.buttondetails1.style.transition = "all 0.5s"
                }
            },
             showdetails2() {
                if (this.show == false) {
                    this.show = true
                    this.$refs.details2.style.display = "block"
                    this.$refs.buttondetails2.style.transform = "rotate(90deg)"
                    this.$refs.buttondetails2.style.transition = "all 0.5s"
                } else {
                    this.show = false
                    this.$refs.details2.style.display = "none"
