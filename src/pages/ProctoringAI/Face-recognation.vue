         ...
         <h1>Face Recognition</h1>
            <div class="line"></div>
                <div class="desc">
                 ...
                 <div class="desc">
                    <p> Facial recognition is a category of <a href="">biometric security.</a> Other forms of biometric software include voice recognition, fingerprint recognition, and eye retina or iris recognition. The technology is mostly used for security and law enforcement, though there is increasing interest in other areas of use.</p>
                </div>
                <div class="image">
                    <img src="../../assets/Perbedaan Face Detec & Face Recog.png" alt="">
                            ...
                            <div class="row">
                                <div class="flex-containers">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <p>Integrating our service with your existing database & enhance security with face profiles.</p>
                                    </div>
                                </div>
                            </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="flex-containers">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <p>Giving a seamless type-free registration process for your users with digital onboarding.</p>
                                </div>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="advantagebox" style=" border-left: 5px solid blue;">
                            <div class="row">
                                <div class="flex-containers">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <strong>Fighting Fraud</strong>
                                        <p>Prevent your business or system from fake users ID.</p>
                                    </div>
                                </div>
                            </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="flex-containers">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <p>Intelligent capture and realtime detection of faces with 99% accuracy.</p>
                                    </div>
                                </div>
                            </div>
                    </div>
            ...
            <div class="line"></div>
                <h2>API Documentation For Using Face Recognition</h2>
                    <div class="desc">
                        <p> Before using facial recognition, you must first register user data (master data). With the following facial recognition functions, it is easy to compare faces with each other. Attached below is the api-docs documentation for user data that can later perform facial recognition that refers to the unique code entered.</p>
                    </div>
             <div class="row mt-3">
                <div class="col-md-12 mt-2">
                    <div class="advantagebox" style=" border-left: 5px solid blue;">
            ...
            <div class="row">
             ...
             <div class="row mt-5">
                <div class="col-md-12 mt-2">
                    <h3>2. Users Image</h3>
                    <p>To manage the master data of users image taking exams using a proctoring service based on previously registered unique code data.</p>
                    <div class="api-details">
                        <div class="head">
                            <div class="api-head">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-circle-fill" viewBox="0 0 16 16">
            ...
            <div class="row mt-5">
                <div class="col-md-12 mt-2">
                    ...
                    <p>After the user data has been registered and the facial image data has been entered according to the existing unique code, the user can start using the facial recognition service by entering the unique code and the comparison face image data in Base64 format.</p>
...
{ 
    "status": 200, 
    "mesages": "Facial Recognition Successfully", 
    "data":{ 
        "conclusion_status": true, 
        "pair_1":{ 
            "distance": 0.12488667456051072 
        }, 
        "pair_2":{ 
            "distance": 0.28401574430379106 
        }, 
        "pair_3":{ 
            "distance": 0.28401574430379106 
        } 
            ...
            <div class="image">
                    <img class="mt-5" src="../../assets/Screen Shot 2022-01-06 at 18.49.02.png" alt="">
